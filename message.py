...
def imagemap_message():
    message = ImagemapSendMessage(
        ...
        base_url="https://i.imgur.com/0OPgq9U.png",
        alt_text='最新的合作廠商有誰呢？',
        base_size=BaseSize(height=500, width=500),
        # actions=[
        #     URIImagemapAction(
        #         #家樂福
        #         # link_uri="https://foodtracer.taipei.gov.tw/Backend/upload/company/25003074/25003074_img2.png",
        #         link_uri="https://foodtracer.taipei.gov.tw/Backend/upload/company/25003074/25003074_img2.png",
        #         area=ImagemapArea(
